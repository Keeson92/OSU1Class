...
namespace Servicelager
{
    public class Affärslager
    {
        ...
        public void StartaUthyrning(int fordonsId, DateTime startTid, DateTime slutTid)
        {
            var uthyrningsData = new UthyrningsData(startTid, slutTid, fordonsId);
            var uthyrningsRepo = new UthyrningsDataRepository();
            uthyrningsRepo.GetAllUthyrningsData().Add(uthyrningsData);
        }
